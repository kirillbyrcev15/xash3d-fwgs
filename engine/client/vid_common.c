...
CVAR_DEFINE( window_width, "width", "600", FCVAR_RENDERINFO|FCVAR_VIDRESTART, "screen width" );
CVAR_DEFINE( window_height, "height", "0", FCVAR_RENDERINFO|FCVAR_VIDRESTART, "screen height" );
CVAR_DEFINE( vid_width, "vid_width", "360", FCVAR_READ_ONLY, "actual window viewport size" );
